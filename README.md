...
1. **AWS Systems Manager Parameter Store**: create a secure parameter (SecureString) that stores your Gemini API key.
   ```bash
...
- `src/app.py`: Lambda handler that calls Gemini and returns images in base64
